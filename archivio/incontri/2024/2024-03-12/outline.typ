= Incontro 2024-03-12: laboratorio alpha
...
== lavoriamo sul problema accensione e prendiamo dimestichezza con la piattaforma TALight

Dove troviamo i problemi?

Una volta installato rtal sulla tua macchina:
```
    rtal -s wss://ta.di.univr.it/algo list
    rtal -s wss://ta.di.univr.it/tutorial list
